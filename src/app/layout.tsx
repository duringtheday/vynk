...
export const metadata: Metadata = {
  title: {
    default: 'Vynk — Make every introduction smart',
    template: '%s | Vynk',
  },
  description:
    'Premium digital business cards. One QR scan — your contact saved instantly on any phone.',
            ...
            <Toaster
              ...
              toastOptions={{
                style: {
                  ...
                  fontSize: '14px',
                  boxShadow:
                    '5px 5px 14px #08090B, -3px -3px 10px #141720',
                },
                success: {
                  iconTheme: {
                    primary: '#D4A84F',
