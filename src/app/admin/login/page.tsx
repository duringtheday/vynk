...
export default function AdminLogin() {
  ...
  return (
    // overflow-y:auto + justifyContent:flex-start garantiza que nunca se corte en ningún dispositivo
    <div style={{
      minHeight: '100dvh',
      background: C.g,
      display: 'flex',
      ...
      <div style={{
        ...
        width: 'auto',
        maxWidth: 'min(180px, calc(100vw - 32px))',
      }}>
        <img src="/logo.png" alt="Vynk" style={{ width: '100%', height: 'auto', display: 'block' }}/>
      </div>

      {/* Card principal — se ajusta al viewport */}
      <div style={{
        width: '100%',
        maxWidth: 'min(360px, calc(100vw - 32px))',
        background: C.g,
        boxShadow: `8px 8px 24px ${C.nd}, -5px -5px 16px ${C.nl}`,
        borderRadius: '22px',
        ...
        {step==='pin' ? (<>
          ...
          <div style={{ textAlign:'center', marginBottom: '4px' }}>
            ...
            <h1 style={{ fontFamily:"'Syne',sans-serif", fontWeight:800, fontSize:'clamp(17px,4vw,20px)', color:C.gold, marginBottom:'4px' }}>Owner Vault</h1>
          ...
          <div style={{ textAlign:'center', marginBottom:'18px' }}>
            ...
            <h1 style={{ fontFamily:"'Syne',sans-serif", fontWeight:800, fontSize:'clamp(17px,4vw,20px)', color:C.gold, marginBottom:'4px' }}>Check your email</h1>
