...
export default function SignUpPage() {
  return (
    <main style={{ minHeight:'100dvh', background:'#0D0F12', display:'flex', flexDirection:'column', alignItems:'center', justifyContent:'flex-start', padding:'32px 20px 80px', fontFamily:"'DM Sans',sans-serif" }}>
      ...
      <p style={{ color:'#6F737A', fontSize:'13px', marginBottom:'24px', fontWeight:300 }}>Create your digital identity</p>
