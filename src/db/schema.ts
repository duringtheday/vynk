...
// ── Cards ─────────────────────────────────────────────────────
// FRONT (paid to change): fullName, title, company, photoUrl, logoUrl, phone, whatsapp, email
// BACK  (free to change): tagline, bio, services, socials, website, address, design
